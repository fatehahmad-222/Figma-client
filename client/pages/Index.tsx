            ...
            <div className="px-5 py-5 sm:px-7">
              ...
              <section className="mt-5">
                ...
                <div className="mt-3 grid gap-3 sm:grid-cols-2">
                  ...
                  <fieldset><legend className="text-xs font-semibold text-slate-700">Employment Type <span className="text-rose-500">*</span></legend><div className="mt-1.5 grid grid-cols-4 overflow-hidden rounded-lg border border-slate-200 text-center text-xs font-medium"><label className="cursor-pointer border-r border-slate-200 bg-emerald-500 px-1 py-2.5 text-white"><input defaultChecked type="radio" name="employmentType" value="Full Time" className="sr-only" />Full Time</label><label className="cursor-pointer border-r border-slate-200 px-1 py-2.5"><input type="radio" name="employmentType" value="Part Time" className="sr-only" />Part Time</label><label className="cursor-pointer border-r border-slate-200 px-1 py-2.5"><input type="radio" name="employmentType" value="Casual" className="sr-only" />Casual</label><label className="cursor-pointer px-1 py-2.5"><input type="radio" name="employmentType" value="Contract" className="sr-only" />Contract</label></div></fieldset>
