...
const employees: Employee[] = [
  ...
  { id: 5, name: "Sarah Johnson", department: "Engineering", role: "Engineering", initials: "SJ", color: "bg-emerald-100 text-emerald-700" },
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800">
      ...
      <main className="mx-auto max-w-[1600px] px-5 py-5 sm:px-8">
        <div className="mb-5 text-xs text-slate-400">Singh Hotel <span className="px-1">/</span> HRMS <span className="px-1">/</span> <strong className="text-slate-700">Employees</strong></div>
        <div className="mb-5 flex items-end justify-between gap-4">
          <h2 className="text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl">Leave Applications</h2>
          <button type="button" onClick={() => setIsModalOpen(true)} className="flex items-center gap-2 rounded-lg bg-green-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-green-700"><Plus className="h-4 w-4" /> Add Leave Application</button>
        </div>
