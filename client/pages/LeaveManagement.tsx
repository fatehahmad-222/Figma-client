      ...
      <main className="mx-auto max-w-[1600px] px-5 py-5 sm:px-8">
        ...
        <section className="mb-4 rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
          <div className="flex flex-col gap-3 lg:flex-row">
            ...
            <button type="button" onClick={() => setFiltersVisible((visible) => !visible)} className="flex items-center justify-center gap-2 rounded-lg bg-green-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-green-700"><Filter className="h-4 w-4" />{filtersVisible ? "Hide Filters" : "Show Filters"}</button>
          </div>
