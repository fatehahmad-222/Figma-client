...
function StatusBadge({ status }: { status: string }) {
  if (status === "Pending") return <span className="rounded bg-amber-100 px-2 py-0.5 text-xs font-bold text-amber-600">Pending</span>;
  if (status === "Approved") return <span className="rounded bg-green-100 px-2 py-0.5 text-xs font-bold text-green-600">Approved</span>;
  return <span className="rounded bg-red-100 px-2 py-0.5 text-xs font-bold text-red-600">Rejected</span>;
}
