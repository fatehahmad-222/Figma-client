      ...
      <div className="px-8 py-8">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
          ...
          <div className="flex gap-3 mb-6">
            ...
            <button className="rounded-lg bg-emerald-600 px-6 py-2 text-sm font-semibold text-white hover:bg-emerald-700">Search</button>
            <button
          ...
          {showFilters && (
            <>
              ...
              {/* Filter Buttons */}
              <div className="flex gap-3 mb-6">
                <button className="rounded-lg bg-emerald-600 px-6 py-2 text-sm font-semibold text-white hover:bg-emerald-700">Apply Filters</button>
                <button
                  onClick={() => {
                    setFilters({
                      employee: "All Employees",
